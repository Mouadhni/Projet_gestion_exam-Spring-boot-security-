        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          ...
          <div className="mt-4">
            ...
            <div className="mx-auto max-w-180">
              ...
              <p className="mt-4.5">
              The project to develop an exam scheduling application for ENSAH using the Spring Framework optimizes exam management by automating tasks such as staff management, room allocation, and supervisor coordination. The layered architecture, incorporating Spring Security, Spring Data JPA, and Spring Boot, ensures a secure and scalable structure. This solution reduces administrative burden and enhances efficiency, contributing to a better experience for all stakeholders and improving the overall quality of ENSAH's educational system.
              </p>
            </div>
