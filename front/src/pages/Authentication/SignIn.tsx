...
const SignIn: React.FC = () => {
  ...
  const navigate = useNavigate(); // Access to history objectà
  ...
  axios.post('http://localhost:8080/login', { username, password })
    .then(response => {
      ...
      if (response.data.statusCode === "OK") {
        ...
        const type = response.data.body.type;
        ...
        localStorage.setItem('user', JSON.stringify(user)); // Example: Store token in localStorage
        ...
        if (response.data.body.type === "ADMIN") {
          ...
          // Handle successful login response
          throw new Error("Type Enseignant");
        } else {
        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              ...
              Hello and welcome to the exam scheduling application developed for ENSAH!
              </p>
