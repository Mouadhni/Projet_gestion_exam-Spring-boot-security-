...
const FormDepatementUpdate = () => {
  ...
  useEffect(() => {
    ...
    const elementToUpdateString = localStorage.getItem('departementToUpdate');
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    console.log(Id+" "+enseignant_id+" "+description)
    
  
    axios.put(

      `http://localhost:8080/login/admin/updateDepartement/${Id}`,  
      ...
      .then(response => {
        ...
        if (response.data.statusCode == "OK") {
          ...
          console.log(response);
          alert("departement got updated successfully")
...
export default FormDepatementUpdate;
