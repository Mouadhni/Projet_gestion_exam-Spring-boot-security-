...
import TableDepartement from '../../../components/Tables/TableDepartement';
const FormDepartementAction = () => {
  ...
  return (
    <DefaultLayout>
      <Breadcrumb pageName="Form Layout" />
          <TableDepartement elementlist={elementlist}  title="Departement List"/>
    </DefaultLayout>
  );
};

export default FormDepartementAction;
