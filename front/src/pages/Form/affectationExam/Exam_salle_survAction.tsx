...
import TableAffectation from '../../../components/Tables/TableAffectation';
const Exam_salle_survAction = () => {
  ...
  useEffect(() => {
    ...
    axios.get('http://localhost:8080/login/admin/getAllExamsWithDetails', {
      headers: {
  ...
  return (
    <DefaultLayout>
      <Breadcrumb pageName="Form Layout" />
          <TableAffectation elementlist={elementlist}  title="Affectation  List"/>
    </DefaultLayout>
  );
};

export default Exam_salle_survAction;
