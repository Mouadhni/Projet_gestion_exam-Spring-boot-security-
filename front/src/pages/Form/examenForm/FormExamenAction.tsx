...
import TableElement from '../../../components/Tables/TableElement';
import TableExamen from '../../../components/Tables/TableExamen';
const FormExamenAction = () => {
  ...
  useEffect(() => {
    ...
    axios.get('http://localhost:8080/login/admin/getAllExamens', {
      headers: {
        ...
        console.log("sdfghjk"+response.data.body);
  ...
  return (
    <DefaultLayout>
      <Breadcrumb pageName="Form Layout" />
          <TableExamen elementlist={elementlist}  title="Element List"/>
    </DefaultLayout>
  );
};

export default FormExamenAction;
