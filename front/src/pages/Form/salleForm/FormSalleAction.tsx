...
import TableSalle from '../../../components/Tables/TableSalle';
const FormSalleAction = () => {
  ...
  return (
    <DefaultLayout>
      <Breadcrumb pageName="Form Layout" />
          <TableSalle elementlist={elementlist}  title="Salle List"/>
    </DefaultLayout>
  );
};

export default FormSalleAction;
